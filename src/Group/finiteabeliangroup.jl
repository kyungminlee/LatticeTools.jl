...
order(group::FiniteAbelianGroup) = size(group.multiplication_table, 1)
n_elements(group::FiniteAbelianGroup) = size(group.multiplication_table, 1)
is_abelian(group::FiniteAbelianGroup) = true
...
"""
function is_subgroup(group::FiniteAbelianGroup,
